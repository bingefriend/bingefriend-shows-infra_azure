    ...
    def upsert_season(self, season_data: dict[str, Any], db: Session) -> Optional[int]:
        ...
        try:
            ...
            season_attrs = {
                ...
                "number": season_data.get("number"),
                "name": season_data.get("name"),
                "episodeOrder": season_data.get("episodeOrder"),  # Verify model field name
                "premiereDate": db_premiere,  # Verify model field name
                "endDate": db_end,  # Verify model field name
